...
def main():
    ...
    CLASSIFIER_PATH = './Models/20180402-114759/celeb_classifier.pkl'
    VIDEO_PATH = args.path
    FACENET_MODEL_PATH = './Models/20180402-114759/20180402-114759.pb'
    # FACENET_MODEL_PATH = './Models/20180402-114759/20170511-185253.pb'
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            while (True):
                ...
                try:
                    # 3 dòng dưới để khóa detect 1 gương mặt trong khung hình
                    #if faces_found > 1:
